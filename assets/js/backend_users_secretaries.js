...
(function () {
    ...
    SecretariesHelper.prototype.bindEventHandlers = function () {
        ...
        $("#secretaries").on(
            ...
            function (event) {
                ...
                var secretary = this.filterResults.find(function (
                    filterResult
                ) {
            ...
            function () {
                var secretary = {
                    ...
                    settings: {
                        ...
                        notifications: $("#secretary-notifications").prop(
                            "checked"
                        ),
    ...
    SecretariesHelper.prototype.resetForm = function () {
        ...
        $("#secretaries .record-details")
            ...
            .val("")
            .prop("disabled", true);
        $("#secretaries .record-details #secretary-calendar-view").val(
            "default"
        );
    ...
    SecretariesHelper.prototype.display = function (secretary) {
        ...
        $("#secretary-notifications").prop(
            "checked",
            Boolean(Number(secretary.settings.notifications))
        );
        ...
        secretary.providers.forEach(function (secretaryProviderId) {
            var $checkbox = $(
                '#secretary-providers input[data-id="' +
                    secretaryProviderId +
                    '"]'
            );
    ...
    SecretariesHelper.prototype.select = function (id, display) {
        ...
        $('#filter-secretaries .secretary-row[data-id="' + id + '"]').addClass(
            "selected"
        );
