...
(function () {
    ...
    WorkingPlan.prototype.setup = function (workingPlan) {
        var weekDayId = GeneralFunctions.getWeekDayId(
            GlobalVariables.firstWeekday
        );
        var workingPlanSorted = GeneralFunctions.sortWeekDictionary(
            workingPlan,
            weekDayId
        );
                        ...
                        $("<tr/>", {
                            html: [
                                ...
                                $("<td/>", {
                                    ...
                                    text: Date.parse(workingDayBreak.start)
                                        .toString(timeFormat)
                                        .toLowerCase(),
                                }),
                                $("<td/>", {
                                    class: "break-end editable",
                                    text: Date.parse(workingDayBreak.end)
                                        .toString(timeFormat)
                                        .toLowerCase(),
                                }),
                                $("<td/>", {
     ...
     */
    WorkingPlan.prototype.renderWorkingPlanExceptionRow = function (
        date,
        workingPlanException
    ) {
        var timeFormat =
        ...
        return $("<tr/>", {
            ...
            html: [
                ...
                $("<td/>", {
                    ...
                    text: Date.parse(workingPlanException.start)
                        .toString(timeFormat)
                        .toLowerCase(),
                }),
                $("<td/>", {
                    class: "working-plan-exception--end",
                    text: Date.parse(workingPlanException.end)
                        .toString(timeFormat)
                        .toLowerCase(),
                }),
                $("<td/>", {
    ...
    WorkingPlan.prototype.bindEventHandlers = function () {
            ...
            function () {
                ...
                var $newBreak = $("<tr/>", {
                    html: [
                        ...
                        $("<td/>", {
                            class: "break-start editable",
                            text: Date.parse("12:00:00")
                                .toString(timeFormat)
                                .toLowerCase(),
                        }),
                        $("<td/>", {
                            class: "break-end editable",
                            text: Date.parse("14:00:00")
                                .toString(timeFormat)
                                .toLowerCase(),
                        }),
                        $("<td/>", {
                ...
                this.editableTimeCell(
                    $newBreak.find(".break-start, .break-end")
                );
        ...
        $(document).on("click", ".edit-break", function () {
            ...
            $tr.find("select,input:text").addClass(
            ...
            function () {
                WorkingPlanExceptionsModal.add().done(
                    function (date, workingPlanException) {
                        ...
                        $(".working-plan-exceptions tbody tr").each(function (
                            index,
                            tr
                        ) {
                        ...
                        var $newTr = this.renderWorkingPlanExceptionRow(
                            date,
                            workingPlanException
                        );
