...
(function () {
    ...
    AdminsHelper.prototype.bindEventHandlers = function () {
        ...
        $("#admins").on(
            ...
            function () {
                ...
                $("#admins .record-details")
                    .find("select")
                    .prop("disabled", false);
                $("#admin-password, #admin-password-confirm").addClass(
                    "required"
                );
        ...
        $("#admins").on("click", "#edit-admin", function () {
            ...
            $("#admin-password, #admin-password-confirm").removeClass(
                "required"
            );
            $("#filter-admins button").prop("disabled", true);
            $("#filter-admins .results").css("color", "#AAA");
            ...
            function () {
                var admin = {
                    ...
                    settings: {
                        ...
                        notifications: $("#admin-notifications").prop(
                            "checked"
                        ),
    ...
    AdminsHelper.prototype.save = function (admin) {
        var url =
            GlobalVariables.baseUrl + "/index.php/backend_api/ajax_save_admin";
    ...
    AdminsHelper.prototype.delete = function (id) {
        var url =
            ...
            "/index.php/backend_api/ajax_delete_admin";
    ...
    AdminsHelper.prototype.display = function (admin) {
        ...
        $("#admin-notifications").prop(
            "checked",
            Boolean(Number(admin.settings.notifications))
        );
    };
    ...
    AdminsHelper.prototype.select = function (id, display) {
        ...
        $('#filter-admins .admin-row[data-id="' + id + '"]').addClass(
            "selected"
        );
